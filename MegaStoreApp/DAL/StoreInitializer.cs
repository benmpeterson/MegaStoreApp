...
namespace MegaStoreApp.DAL
{
    public class StoreInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<StoreContext>
    {
        protected override void Seed(StoreContext context)
        {
            ...
            new Album{AlbumID=2021,Artist = "Kanye West", Title="The College Dropout", Genre = "Hip Hop",Price=9.99M,
                AlbumArtLocation ="~/Content/Images/collegedropout.jpg",
                SpotifyURL ="https://embed.spotify.com/?uri=spotify%3Atrack%3A62r62ArmWq38cu6QCVgyTc"},
            new Album{AlbumID=2042,Artist = "Marvin Gaye",Title="What's Going On", Genre = "Soul" ,Price=9.99M,
                AlbumArtLocation ="~/Content/Images/marvingaye.jpg",
                SpotifyURL ="https://embed.spotify.com/?uri=spotify%3Atrack%3A2PR9fRMWxg4oiNnuJd64NX"},
            new Album{AlbumID=3000,Artist = "Alex G",Title="Rules", Genre = "Indie Rock" ,Price=9.99M,
                AlbumArtLocation ="~/Content/Images/rules.jpg",
                SpotifyURL ="https://embed.spotify.com/?uri=spotify%3Atrack%3A4PL0neV0CW44OxbbwVT9zl"},
            new Album{AlbumID=7000,Artist = "RadioHead",Title="In Rainbows", Genre = "Electronic" ,Price=9.99M,
                AlbumArtLocation ="~/Content/Images/radiohead.jpg",
                SpotifyURL ="https://embed.spotify.com/?uri=spotify%3Atrack%3A6dsq7Nt5mIFzvm5kIYNORy"}
            };
